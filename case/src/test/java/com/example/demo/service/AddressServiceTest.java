...
//    }
    ...
    @Test
    public void mds() throws JsonProcessingException {
        String personasstring = new ObjectMapper().writeValueAsString(mockPerson);
        Person a  = new ObjectMapper().readValue(personasstring,Person.class);
        System.out.printf("");
    }
